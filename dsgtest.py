...
mechdesign1 = dsg.designhorzpres(Di=78., L=480., Po=470., To=800.)

# Example 2: Vertical pressure vessel
# Po = 95.5 psig, To = 150 degF, Di = 120 in, L = 2544 in
mechdesign2 = dsg.designhorzpres(Di=120., L=2544., Po=95.5, To=150)

# Example 3: Vacuum vessel
# Po = 7.977 psig, To = 257 degF, Di = 168 in, L = 1080 in
mechdesign3 = dsg.designvac(Di=168., L=1080., Po=7.977, To=257.)
...
comppower, compeff, T2 = dsg.sizecompressor(m=1e5, P1=100, P2=300, T1=323.15, cp=1.02, cv=0.72, Z=0.99)

# Example 5: Pump sizing for required power
# Q = 35 m^3/h, dP = 500 kPa, rho = 1000 kg/m^3 (default)
pumppower, pumpeff = dsg.sizepump(Q=35, dP=500)
...
A1, F1 = dsg.sizeHE_heater(mc=31715, cpc=3246, Tcin=89, Tcout=101, Thin=160, Thout=156, U=850)
...
A2, F2 = dsg.sizeHE_cooler(mh=31715, cph=3246, Thin=89, Thout=60, Tcin=5, Tcout=10, U=850)